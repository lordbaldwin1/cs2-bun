...
export async function getPearsonCorrelations() {
  ...
  const correlations = {
    lr: lrDenomX > 0 && lrDenomY > 0 ? lrNumerator / Math.sqrt(lrDenomX * lrDenomY) : null,
    hr: hrDenomX > 0 && hrDenomY > 0 ? hrNumerator / Math.sqrt(hrDenomX * hrDenomY) : null,
    kd: kdDenomX > 0 && kdDenomY > 0 ? kdNumerator / Math.sqrt(kdDenomX * kdDenomY) : null,
    aim: aimDenomX > 0 && aimDenomY > 0 ? aimNumerator / Math.sqrt(aimDenomX * aimDenomY) : null,
    util: utilDenomX > 0 && utilDenomY > 0 ? utilNumerator / Math.sqrt(utilDenomX * utilDenomY) : null,
  };
