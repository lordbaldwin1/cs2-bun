...
import { handlerGetPlayerCount, handlerGetPlayers } from "./api/players";
...
app.get("/api/players/count", (req, res, next) => {
  Promise.resolve(handlerGetPlayerCount(req, res).catch(next));
});
